export default function generateCar(color: string | undefined): string {
  return `<svg
  ...
  <g
    ...
    <g
      ...
      <path
         ...
         style="fill:${
  color || '#ffffff'
};fill-opacity:1;fill-rule:evenodd;stroke:#fef4f4;stroke-width:0.9701907;stroke-opacity:1" />
    </g>
  </g>
  <metadata
     id="metadata22">
